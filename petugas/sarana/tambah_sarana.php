  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="box box-info">
        <!-- form start -->
        <form action="sarana/proses_sarana.php" method="POST" class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              <label for="nm_sarana" class="col-sm-2 control-label">NAMA SARANA</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="nm_sarana" name="nm_sarana" placeholder="Masukan Nama Sarana">
              </div>
            </div>
            <div class="form-group">
